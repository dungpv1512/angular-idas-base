...
```typescript
import { BaseSearchComponent } from '@app/shared/components/base-search/base-search.component';
...
```typescript
import { SearchResult } from '@app/shared/components/base-search/base-search.component';
