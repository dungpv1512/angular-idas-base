...
```typescript
import { IdasTagsInputComponent } from '@app/shared/components/idas-tags-input/base-tags-input.component';
...
```typescript
import { IdasTagsInputComponent, TagsSearchResult } from '@app/shared/components/idas-tags-input/base-tags-input.component';
