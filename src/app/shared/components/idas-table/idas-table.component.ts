...
/**
 * IDAS Table Component
 * Reusable table với pagination, sorting, actions
 * Hỗ trợ cả flat table, tree table và virtual scroll
 */
@Component({
  selector: 'app-idas-table',
  standalone: true,
  imports: [
    CommonModule,
    NzTableModule,
  ...
  templateUrl: './idas-table.component.html',
  styleUrl: './idas-table.component.less',
  changeDetection: ChangeDetectionStrategy.OnPush
})
export class IdasTableComponent implements OnInit, OnChanges {
  ...
  @Input() actionsColumnTitle = 'common.actions';
  @Input() defaultConfirmText: string = 'common.confirm';

  @Output() pageChange = new EventEmitter<number>();
  @Output() pageSizeChange = new EventEmitter<number>();
  @Output() queryParamsChange = new EventEmitter<any>();
  @Output() checkChange = new EventEmitter<{ keys: string[]; records: any[] }>();
